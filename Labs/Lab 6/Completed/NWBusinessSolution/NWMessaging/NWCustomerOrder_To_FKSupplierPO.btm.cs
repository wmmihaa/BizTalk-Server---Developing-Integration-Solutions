namespace NWMessaging {
    ...
    public sealed class NWCustomerOrder_To_FKSupplierPO : Microsoft.XLANGs.BaseTypes.TransformBase {
        
        private const string _strMap = @"<?xml version=""1.0"" encoding=""UTF-16""?>
<xsl:stylesheet xmlns:xsl=""http://www.w3.org/1999/XSL/Transform"" xmlns:msxsl=""urn:schemas-microsoft-com:xslt"" xmlns:var=""http://schemas.microsoft.com/BizTalk/2003/var"" exclude-result-prefixes=""msxsl var s0 s1 userCSharp userVB"" version=""1.0"" xmlns:s0=""http://NWMessaging.ShippingAddress"" xmlns:s1=""http://NWMessaging.CustomerOrder"" xmlns:ns0=""http://FKMessaging.SupplierPO"" xmlns:userCSharp=""http://schemas.microsoft.com/BizTalk/2003/userCSharp"" xmlns:userVB=""http://schemas.microsoft.com/BizTalk/2003/userVB"">
  ...
  <xsl:template match=""/s1:CustomerOrder"">
    <ns0:PurchaseOrder>
      ...
      <xsl:for-each select=""/s1:CustomerOrder/Lines/SalesOrderLine"">
      ...
      <xsl:for-each select=""/s1:CustomerOrder/Lines/SalesOrderLine"">
        <xsl:variable name=""var:v5"" select=""userCSharp:MathMultiply(string(Quantity/text()) , string(UnitPrice/text()))"" />
...
public bool IsNumeric(string val, ref double d)
{
	...
	return Double.TryParse(val, System.Globalization.NumberStyles.AllowThousands | System.Globalization.NumberStyles.Float, System.Globalization.CultureInfo.InvariantCulture, out d);
        ...
        private const FKMessaging.SupplierPO _trgSchemaTypeReference0 = null;
